...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OCaml_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c3abd6fe-9069-5508-9372-c239bf6209ff"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OCaml", artifacts_toml) for e in artifacts["OCaml"]]
...
if best_platform === nothing
    @debug("Unable to load OCaml; unsupported platform $(triplet(platform_key_abi()))")
else
